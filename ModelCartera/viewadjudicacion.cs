...
namespace ModelCartera
{
    public class viewadjudicacion
    {
        ...
        public string TercerTitular { get; set; }
        public decimal RcdCapital { get; set; }
        public decimal RcdInteresCte { get; set; }
        public decimal RcdInteresMora { get; set; }
        public decimal Saldo { get; set; }
        //public int MaxCI { get; set; }
        //public int MaxFN { get; set; }
        //public int MaxCE { get; set; }
        //public int MaxCO { get; set; }
    }
}
