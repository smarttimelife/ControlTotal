...
{
    [Table("formularios")]
    public class formularios : baseViewModel
    {
        // Atributos de clase
        ...
        public formularios(int Id, string IdFormulario, string NombreFormulario, string Modulo, int IdSoftware, bool Ver, bool Adicionar, bool Modificar, bool Eliminar, bool Cerrar, bool Imprimir, bool Aprobar, bool Desaprobar)
        {
            this._Id = Id;
