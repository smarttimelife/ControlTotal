namespace ControlTotal
{
    ...
    public partial class XtraTramiteEscritura : DevExpress.XtraEditors.XtraForm
    {
        #region Propiedades
        ...
        public XtraTramiteEscritura(CadenaConexionMysql cadenaConexion)
        {
            ...
            GrdAdjudicacion.DataSource = NegDocumentacion.CnsDtConsultaStrId("EstadosAdj", "Tramite Escrituracion");
        ...
        private void BtnAceptar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                NegDocumentacion_Error_Event_String_negConsultas("No Ahy Negocios Tramite Escritruacion");
            }
            else
            {
                string IdAdj = GrvAdjudicacion.GetFocusedRowCellValue("IdAdjudicacion").ToString();
                XtraAceptarDocumento Documento = new XtraAceptarDocumento(CadenaConexion, IdAdj, "Tramite Escrituracion");
        ...
        private void BtnEnviarTramite_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (GrvAdjudicacion.DataRowCount == 0)
            {
                NegDocumentacion_Error_Event_String_negConsultas("No Ahy Negocios En Tramites");
            }
            else
            {
                string IdAdj = GrvAdjudicacion.GetFocusedRowCellValue("IdAdjudicacion").ToString();
                XtraDocumentacion Documento = new XtraDocumentacion(CadenaConexion, IdAdj, "Escriturados");
                Documento.ShowDialog();
                GrdAdjudicacion.DataSource = NegDocumentacion.CnsDtConsultaStrId("EstadosAdj", "Tramite Escrituracion");
            }
        }
        ...
        {
            Operaciones.impirmir(GrdAdjudicacion, "NEGOCIOS TRAMITE ESCRITURACION");
        }
        ...
        private void GrdAdjudicacion_DoubleClick(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    NegDocumentacion_Error_Event_String_negConsultas("Documento En Tramite No ha Sido Aceptado");
                }
            }
        }
