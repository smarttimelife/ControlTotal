namespace ControlTotal
{
    ...
    public partial class XtraEscriturados : DevExpress.XtraEditors.XtraForm
    {
        #region Propiedades
        ...
        public XtraEscriturados(CadenaConexionMysql cadenaConexion)
        {
            ...
            GrdAdjudicacion.DataSource = NegDocumentacion.CnsDtConsultaStrId("EstadosAdj", "Escriturados");
        ...
        {
            XtraMessageBox.Show(mensaje, "Escriturados", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        private void BtnAceptar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                NegDocumentacion_Error_Event_String_negConsultas("No Ahy Negocios Escriturados");
            }
            else
            {
                string IdAdj = GrvAdjudicacion.GetFocusedRowCellValue("IdAdjudicacion").ToString();
                XtraAceptarDocumento Documento = new XtraAceptarDocumento(CadenaConexion, IdAdj, "Escriturados");
                Documento.ShowDialog();
                GrdAdjudicacion.DataSource = NegDocumentacion.CnsDtConsultaStrId("EstadosAdj", "Escriturados");
            }
        }

        private void BtnEnviarArchivados_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (GrvAdjudicacion.DataRowCount == 0)
            {
                NegDocumentacion_Error_Event_String_negConsultas("No Ahy Negocios Escriturados");
            ...
            {
                string IdAdj = GrvAdjudicacion.GetFocusedRowCellValue("IdAdjudicacion").ToString();
                XtraDocumentacion Documento = new XtraDocumentacion(CadenaConexion, IdAdj, "Archivados");
                Documento.ShowDialog();
                GrdAdjudicacion.DataSource = NegDocumentacion.CnsDtConsultaStrId("EstadosAdj", "Escriturados");
            }
        }
        ...
        {
            Operaciones.impirmir(GrdAdjudicacion, "NEGOCIOS ESCRITURADOS");
        }
        ...
        private void GrdAdjudicacion_DoubleClick(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    NegDocumentacion_Error_Event_String_negConsultas("Documento Escriturado Sido Aceptado");
                }
            }
        }
        ...
        private void GrvAdjudicacion_CustomRowCellEdit(object sender, CustomRowCellEditEventArgs e)
        {
            ...
            if (Documen != "Recibido")
            {
                BtnEnviarArchivados.Enabled = false;
                BtnAceptar.Enabled = true;
            }
            else
            {
                BtnEnviarArchivados.Enabled = true;
